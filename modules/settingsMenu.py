...
def settings(screen):
    ...
    # if (manifest.isSuperSecretBuild == False):
    ...
    # else:
    #     checksum=Button(screen,300,540,215,95,text="Checksums required",fontSize=30,margin=20,inactiveColour=(100, 100, 100),hoverColour=(130, 130, 130),pressedColour=(130, 130, 130),radius=20)

    ## !! Hotfix 2 resolved !! removed because of dramatically increased loading times, checksums no longer function. Button hidden to prevent the user from changing the useless setting
